...
Enumerate open ports and find port SMB is running
```bash
...
# 3 sets of username and password found
...
```
After bruteforcing, run code below on new Terminal tab
-> It gives access to the target machine
```bash
...
-r--                        0530
100666/rw-rw  32      fil   2020-09-25 12:11:35 +  flag.txt     <- Here!
-rw-                        0530
